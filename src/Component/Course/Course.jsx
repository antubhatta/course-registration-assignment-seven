...
const Course = ({course,handleSelectCourse}) => {
    ...
    return (
        <div className="bg-[#FFF] rounded-xl">
           ...
           <button onClick={()=>handleSelectCourse(course,credit)} className='text-[#FFF] px-36 py-2 text-lg font-semibold bg-[#2F80ED] rounded-lg border border-[#2F80ED]'>Select</button>
           </div>
        </div>
    );
};
